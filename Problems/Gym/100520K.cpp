...
// -1 => empty (half-plane intersection doesn't exist)
// 0 => convex (part of the plane which is finite, will be given in the second argument, note that the area will probably be 0 when it forms a segment)
// 1 => infinity (part of the plane which is infinite, note that the area will probably be 0 when it forms a line or a ray)
template<typename T> int halfplane_intersection(std::vector<Line<T>> pts, Convex<double> &ret) {
